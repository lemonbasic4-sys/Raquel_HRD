...
<div class="page-hero fadeup">
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-0 gap-3">
        <div>
            <div style="font-size:.72rem;text-transform:uppercase;letter-spacing:1px;color:rgba(255,255,255,.55);">Supervisor Portal · Inbox</div>
            <h4 class="text-white fw-bold mb-0 mt-1"><i class="fas fa-bell me-2" style="color:var(--primary-light);"></i>Notification Center</h4>
            <p class="text-white-50 small mb-0 mt-2 d-none d-sm-block">Stay updated with endorsement requests, evaluation submissions, and system alerts</p>
        </div>
        <a href="<?php echo BASE_URL; ?>/supervisor/dashboard.php" class="btn btn-outline-light btn-sm px-3" style="border-radius: 20px;">
